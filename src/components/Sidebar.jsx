...
const Sidebar = ({menuItems}) => {
  ...
  return (
    ...
    isPending ? "pending" : isActive ? "   hover:bg-primary/20 rounded-md font-medium py-4 text-[14px] flex items-center gap-x-4 cursor-pointer px-2 text-primary duration-300 bg-primary/20 mb-2" : "text-textLight   hover:bg-primary/20 rounded-md font-medium py-4 text-[14px] flex items-center gap-x-4 cursor-pointer px-2 hover:text-primary duration-300 mb-2"
  }>
                {menu.icon}
                  {open && menu.title}
        ...
        {/* profile section */}
        <div className="flex  items-center px-0 mt-24 gap-2 ">
